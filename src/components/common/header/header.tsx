...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b bg-white dark:bg-background shadow-md">
      <div className="flex items-center justify-between max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <a
          href="/"
        ...
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden md:block">
            <ul className="flex items-center gap-2">
              <li className="rounded-lg bg-accent h-10 w-24 transition-all duration-300 hover:shadow-md">
                <a href="/about" className="flex justify-center items-center gap-2 w-full h-full">
                  <User className="h-4 w-4" />
                  About
                </a>
              </li>
              <li className="rounded-lg bg-accent h-10 w-24 transition-all duration-300 hover:shadow-md">
                <a href="/works" className="flex justify-center items-center gap-2 w-full h-full">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild className="md:hidden">
              <Button variant="ghost" size="icon" className="rounded-lg shadow-sm hover:shadow-md">
            ...
            >
              <SheetHeader>
                <SheetTitle className="text-left h-8">
                  <a
                    href="/"
                    className="inline-flex items-center gap-2 hover:opacity-70 transition-all duration-300 h-full"
                  >
                    <Home className="h-6 w-6" />
                    <span className="text-lg font-semibold">Portfolio</span>
                  </a>
